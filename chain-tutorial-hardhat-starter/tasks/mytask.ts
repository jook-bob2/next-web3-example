...
task(
  "transfer",
  "Transfer ERC20 ClassToken(CLT) at 0x5FbDB2315678afecb367f032d93F642f64180aa3"
)
    ...
    return getContractAt(
      ...
      .then((contract: Contract) => {
        return contract.transfer(
          params.to,
          hre.ethers.utils.parseEther(params.amount)
        );
      })
      .then((tr: TransactionResponse) => {
        return tr.wait().then((receipt: TransactionReceipt) => {
          console.log(
            "transfer receipt got, transfer completed at block:",
            receipt.blockNumber
          );
        });
      })
